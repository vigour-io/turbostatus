...
const getBranch = exports.getBranch = (folder) => new Promise((resolve, reject) => {
...
const getLocalCommit = exports.getLocalCommit = (folder) => new Promise((resolve, reject) => {
  process.chdir(folder)
...
const getRemoteCommit = exports.getRemoteCommit = (folder) => new Promise((resolve, reject) => {
  process.chdir(folder)
...
const getMergeBase = exports.getMergeBase = (folder) => new Promise((resolve, reject) => {
  process.chdir(folder)
...
const hasUncommited = exports.hasUncommited = (folder) => new Promise((resolve, reject) => {
  process.chdir(folder)
...
const hasUntracked = exports.hasUntracked = (folder) => new Promise((resolve, reject) => {
  process.chdir(folder)
...
const describe = exports.describe = (folder) => new Promise((resolve, reject) => {
  process.chdir(folder)
...
const updateRemotes = exports.getOrigin = (folder) => new Promise((resolve, reject) => {
  process.chdir(folder)
...
exports.getOrigin = (folder) => new Promise((resolve, reject) => {
  process.chdir(folder)
...
exports.clone = (origin, folder) => new Promise((resolve, reject) => {
  exec(`git clone ${origin} ${folder}`, (err, stdout, stderr) => {
    if (err) {
      reject(err)
    } else {
      resolve(stdout)
...
exports.checkout = (folder, commit) => new Promise((resolve, reject) => {
  process.chdir(folder)
...
exports.references = (folder) => new Promise((resolve, reject) => {
  process.chdir(folder)
